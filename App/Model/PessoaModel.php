...
class PessoaModel extends Model
{
     ...
     */
    public $id, $Nome, $Email, $Endereco, $RG, $CPF, $Cel, $Tipo_Pessoa;
    ...
    public function save()
    {
        ...
        // Processa os tipos de pessoa selecionados no formulário
        $tipo_pessoa = implode(',', $_POST['tipo_pessoa']);
        // Atribui os tipos de pessoa ao modelo
