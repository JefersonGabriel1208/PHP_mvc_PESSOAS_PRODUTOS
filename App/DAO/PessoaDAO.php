...
class PessoaDAO extends DAO
{
    ...
    public function insert(PessoaModel $model)
    {
        ...
        $sql= " INSERT INTO pessoas (Nome, Email, Endereco, RG, CPF, Cel, Tipo_Pessoa) VALUES(?,?,?,?,?,?,?)";
        ...
        $stmt-> bindValue (6, $model->Cel);
        $stmt-> bindValue (7, $model->Tipo_Pessoa);
    ...
    {
        $sql = "UPDATE pessoas SET Nome=?, Email=?, Endereco=?, RG=?, CPF=?,Cel=?, Tipo_Pessoa=? WHERE id=? ";
