...
class ProdutoDAO extends DAO
{
    ...
    public function insert(ProdutoModel $model)
    {
        ...
        $sql= " INSERT INTO produtos (nome, preço, custo) VALUES(?,?,?)";
        ...
        $stmt-> bindValue (2, $model->preço);
        $stmt-> bindValue (3, $model->custo);
    ...
    {
        $sql = "UPDATE produtos SET nome=?, preço=?, custo=? WHERE id=? ";
